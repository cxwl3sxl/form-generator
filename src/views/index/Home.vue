<template>
  <div class="container">
        ...
        <div class="components-list">
          <div v-for="(item, listIndex) in leftComponents" :key="listIndex">
            <div class="components-title">
              <div><svg-icon icon-class="component" /> {{ item.title }}</div>
              <div v-if="item.title == '业务组件'">
                <span class="btn" @click="codeDialogVisible=true"> <svg-icon icon-class="code" /></span>
              </div>
            </div>
            <draggable
    ...
    <set-code-dialog :visible.sync="codeDialogVisible" @confirm="parseCode" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    parseCode(code) {
      const csCode = new CSharp(code)
      csCode.parse()
      this.leftComponents[0].list = csCode.getComponents()
    }
  }
}
</script>
